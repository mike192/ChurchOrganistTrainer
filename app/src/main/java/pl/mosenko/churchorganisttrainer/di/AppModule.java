...
import pl.mosenko.churchorganisttrainer.domain.services.ServicesModule;
...
@Module(includes = {AndroidInjectionModule.class, AppDatabaseModule.class, ServicesModule.class})
